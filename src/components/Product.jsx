  ...
  return (
    <div className="product">
      ...
      <div className="product-container">
        ...
        <Box image={image2} name="Water Melon" price="$15.3" />
        <Box image={image3} name="Water Melon" price="$18.3" />
        <Box image={image4} name="Water Melon" price="$24.3" />
        <Box image={image5} name="Water Melon" price="$13.3" />
